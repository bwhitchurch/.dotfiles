    ...
    fun! s:Doxygen_Hilights()
      ...
      if (exists('g:doxygen_enhanced_color') && g:doxygen_enhanced_color) || (exists('g:doxygen_enhanced_colour') && g:doxygen_enhanced_colour)
        if &background=='light'
          ...
          SynColor doxygenComment ctermfg=DarkRed guifg=DarkRed
          SynColor doxygenBrief cterm=bold ctermfg=LightBlue ctermbg=darkgrey guifg=LightBlue gui=Bold,Italic
          SynColor doxygenBody ctermfg=LightBlue guifg=LightBlue
          ...
          SynColor doxygenParamName cterm=italic ctermfg=LightGreen guifg=LightBlue gui=italic,bold
          SynColor doxygenSpecialOnelineDesc cterm=bold ctermfg=LightCyan guifg=LightCyan gui=bold
          SynColor doxygenSpecialHeading cterm=bold ctermfg=LightRed guifg=LightBlue gui=bold
          SynColor doxygenPrev ctermfg=DarkGreen guifg=DarkGreen
        endif
      else
