...
" Shades of plain
let s:bwc.blackestgravel = ['161513', 233]
let s:bwc.blackgravel = ['2c2a26', 235]
let s:bwc.darkgravel = ['423f39', 238]
let s:bwc.deepergravel = ['58544c', 240]
let s:bwc.deepgravel = ['6e6a60', 242]
let s:bwc.mediumgravel = ['847f73', 244]
let s:bwc.gravel = ['9a9486', 246]
let s:bwc.lightgravel = ['b0a999', 249]
let s:bwc.lightergravel = ['c6beac', 251]
let s:bwc.brightgravel = ['ddd4c0', 253]
" A color sampled from a highlight in a photo of a glass of Dale's Pale Ale on
" my desk.
let s:bwc.dalespale = ['fade3e', 220]

" A beautiful tan from Tomorrow Night.
let s:bwc.dirtyblonde = ['fceb89', 222]

" Delicious, chewy red from Made of Code for the poppiest highlights.
let s:bwc.taffy = ['ff0a8c', 198]

" Another chewy accent, but use sparingly!
let s:bwc.saltwatertaffy = ['64bc00', 70]
...
" * The cursor
" * A REPL prompt
let s:bwc.tardis = ['003b6f', 18]

" This one's from Mustang, not Florida!
let s:bwc.orange = ['ff7c0a', 208]

" A limier green from Getafe.
let s:bwc.lime = ['7fef00', 118]

" Rose's dress in The Idiot's Lantern.
let s:bwc.dress = ['cea4ff', 183]

" Another play on the brown from Clouds Midnight.  I love that color.
let s:bwc.toffee = ['6f3400', 94]

" Also based on that Clouds Midnight brown.
let s:bwc.coffee    = ['bc5800', 130]
let s:bwc.darkroast = ['3c1c00', 58]
...
call s:HL('texStatement', 'taffy', '', 'none')
